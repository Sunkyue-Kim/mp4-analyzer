export const I18N = {
  en: {
    ...
    "frameInternals.videoEstimateNote": "Color intensity distributes this sample's byte size across the nominal coding-unit grid as an estimate; it is not decoded per-block entropy data.",
  ...
  ko: {
    ...
    "frameInternals.videoEstimateNote": "색 강도는 이 샘플의 byte 크기를 nominal coding-unit grid에 추정 분배한 값입니다. decoded per-block entropy 데이터가 아닙니다.",
